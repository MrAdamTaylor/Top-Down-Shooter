...
namespace Infrastructure.StateMachine.States
{
    public class LoadAsyncLevelState : IPayloadedState<string>, IDisposable
    {
        ...
        private void LoadEnemySpawner()
        {
            ...
            List<EnemySpawnerPool> enemyPools = CreatePools(spawnerConfigs, _enemyFactory, spawnPoints, spawnController, maximumEnemies);
        ...
        {
            Debug.Log("<color=yellow> Finish Action </color>");
